...
//		File folder = new File("C:\\Users\\Ryan Yu\\workspace\\ImportantFreq\\FilteredDataFolder");
		...
		try{
			for(File file: listOfFiles){
				...
				ProcessBuilder builder = new ProcessBuilder("cmd.exe", "/c", "java -classpath libsvm.jar svm_train -v 10 \"D:\\javaworkspace\\EEGPreProccessing\\src\\FilteredDataFolder\\"+file_name+"\"");
